...
public class AgencyController {
	...
	public static void operations() {
		...
		// int operation = Integer.parseInt(JOptionPane.showInputDialog("--- select
		// operation ---"+
	...
	public static void deposit() {
		...
		// int accountNumber = Integer.parseInt(JOptionPane.showInputDialog("insert
		...
		if (account != null) {
			...
			// Double depositValue = Double.parseDouble(JOptionPane.showInputDialog("insert
			// account number for deposit"));
...
//achei q fiquei meio estranho a logoca do metodo, evolui para opcao valida pos login apenas
	public static void withdraw() {
		// int accountNumber = Integer.parseInt(JOptionPane.showInputDialog("insert
		// number account for withdraw"));
		System.out.println("insert account number ");
		int accountNumber = scan.nextInt();
		Account account = findAccount(accountNumber);

		if (account != null) {
			// Double withDrawValue = Double.parseDouble(JOptionPane.showInputDialog("insert
			// the value withdraw"));
			Double withDrawValue = Double.parseDouble("insert the value withdraw");
	...
	public static void transfer() {
		...
		if (accountRemetente != null) {
			...
			int numberAccountDestinatario = Integer
					.parseInt(JOptionPane.showInputDialog("insert the number account destinatario"));
